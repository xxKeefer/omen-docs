...
<Callout emoji="🤕">
    **EXAMPLE: Healing Scars** <br />
    Below are a few examples of how one may heal a scar. - Foregoing a major milestone to instead heal
    the scar - Spending a predetermined amount of BP to pay a doctor to heal it - Taking a quest that
    helps the character overcome their scar - Overcoming a major story point or defeating the villain
    who caused the scar - A time skip or major period of down time
</Callout>

<Callout emoji="⚠️" type="warning">
    Be careful when adjusting rules for Scars as it has the potential to influence the state of the
    game. If a player thinks they are fragile, they may play in a low risk, less exciting way. If
    they feel invincible, it can remove stakes and mess with the suspension of disbelief. It
    requires a balance.
</Callout>
