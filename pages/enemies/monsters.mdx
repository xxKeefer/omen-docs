...
<Callout emoji="✨">
    **The Black Medusa's Scene Concept** <br />
    Stony Stare: _"You may not explore out of a zone you share with The Black Medusa."_
</Callout>
...
<Callout emoji="✨">
    **Generic Example Routine** <br />- Turn 1: Upgraded Overcome - Turn 2: Foreshadow with minor effect
    - Turn 3: Ult
</Callout>
...
<Callout emoji="✨">
    **Example Defense Concepts** <br />- **Evening The Odds:** When this creature rolls an odd number
    to defend, it adds +1 to it - **Balanced Measure:** This enemy must re-roll all 1s and 8s. - **Prickly
    Exterior:** If this enemy rolls an 8 to defend, the attacker takes 1.
</Callout>
